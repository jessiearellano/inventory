...
@Injectable()
export class StoreSkuPopupService {
            ...
            if (id) {
                this.storeSkuService.find(id)
                    .subscribe((storeSkuResponse: HttpResponse<StoreSku>) => {
                        const storeSku: StoreSku = storeSkuResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.storeSkuModalRef(component, new StoreSku());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    storeSkuModalRef(component: Component, storeSku: StoreSku): NgbModalRef {
